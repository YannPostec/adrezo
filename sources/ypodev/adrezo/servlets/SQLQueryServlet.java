...
public class SQLQueryServlet extends HttpServlet {
	...
	public void init() throws ServletException {
		...
		try {
			...
			// ID 23 : Template Sites
			this.selectlist.put(23,"select id,name,mask,nbvlan,nbsubnet from tpl_site_display");
			this.searchlist.put(23,"lower(name) like lower('%#SEARCHSTR#%') or cast(mask as "+castchar+") like '%#SEARCHSTR#%'");
			// ID 24 : Template Vlans
			this.selectlist.put(24,"select id,vid,def from tpl_vlan");
			...
			this.selectlist.put(25,"select id,def,mask,ip,gw,vlan,vid,vname from tpl_subnet_display");
			this.searchlist.put(25,"lower(def) like lower('%#SEARCHSTR#%') or lower(vname) like lower('%#SEARCHSTR#%') or cast(mask as "+castchar+") like '%#SEARCHSTR#%' or cast(vid as "+castchar+") like '%#SEARCHSTR#%' or ip like '%#SEARCHIPSTR#%' or gw like '%#SEARCHIPSTR#%'");
