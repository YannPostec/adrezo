...
<sql:query var="subnets">select * from subnets_display where vid=0</sql:query>
<div id="tablewrapper">
	<div id="tableheader">
  	<div class="search">
	...
	<table id="table" class="tinytable">
		...
		<tbody><c:forEach items="${subnets.rows}" var="subnet"><tr><td>${subnet.ctx_name}</td><td>${subnet.site_name}</td><td><adrezo:displayIP value="${subnet.ip}" />/${subnet.mask}</td><td>${subnet.def}</td></tr></c:forEach></tbody>
	</table>
	<div id="tablefooter">
		<div id="tablenav">
			<div>
