...
<input type="hidden" id="sqs_id" value="8" />
<input type="hidden" id="sqs_limit" value="32" />
<input type="hidden" id="sqs_offset" value="0" />
<input type="hidden" id="sqs_order" value="site_name" />
...
<table><thead><tr><th /><th /><th><fmt:message key="admin.site" /></th><th><fmt:message key="common.table.vid" /></th><th><fmt:message key="common.table.name" /></th></tr></thead>
<tbody><tr>
	...
	<td><input type="text" size="5" id="add_vid" value="" /></td>
...
<div id="tablewrapper">
	...
	<table id="tableheaders" class="overheaders">
		<thead><tr><th class="nosort"><h3 /></th><th class="nosort"><h3 /></th><th><h3><fmt:message key="admin.site" /></h3></th><th><h3><fmt:message key="common.table.vid" /></h3></th><th><h3><fmt:message key="common.table.name" /></h3></th></tr></thead>
	</table>
