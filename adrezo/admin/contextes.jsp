...
<head>
<title><fmt:message key="admin.ctx.title" /></title>
...
<script type="text/javascript" charset="utf-8" src="../js/admin_contextes.js"></script>
...
<td><input type="hidden" value="${ctx.ID}" />${ctx.NAME}</td>
</tr>
</c:forEach>
</tbody>
</table>
