...
<fmt:message key="admin.csv.subnet" /> : ${cptInsert}<fmt:message key="admin.csv.added" />, ${cptUpdate}<fmt:message key="admin.csv.modified" />, ${erreur}<fmt:message key="admin.csv.errors" />.<br /><c:if test="${erreur > 0}">${message}<br /></c:if>
</c:if>
