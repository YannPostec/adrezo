...
<fmt:message key="common.select.surnet" var="lang_commonselectsurnet" />
...
<link rel="stylesheet" href="../stylesheet/template.css" type="text/css" />
...
<script type="text/javascript" charset="utf-8" src="../js/template_nonstd_subnets.js"></script>
</head>
...
<h2><fmt:message key="template.subnet.title" />${param.tpl}<br /><fmt:message key="template.site.nonstd" /></h2>
...
<table style="display:none;"><tbody><tr><td id="spanshadow"><span onmouseover="javascript:tooltip.show('${lang_commonselectsurnet}')" onmouseout="javascript:tooltip.hide()"><img src="../img/icon_database.png" alt="${lang_commonselectsurnet}" onclick="javascript:ChooseSurnet(event)" /></span></td></tr></tbody></table>
...
<table><thead><tr><th /><th /><th><fmt:message key="common.table.mask" /></th><th><fmt:message key="common.table.name" /></th><th><fmt:message key="admin.subnet" /></th><th><fmt:message key="common.table.ipgw" /></th><th><fmt:message key="admin.vlan" /></th><th><fmt:message key="common.table.ipbc" /></th><th><fmt:message key="norm.surnet" /></th></tr></thead>
<tbody><tr>
	...
	<td><input type="hidden" id="add_tpl" value="${param.tpl}" /><input type="text" size="3" id="add_mask" value="" onchange="javascript:calcBC(event)" /></td>
	...
	<td style="text-align:center"><input type="hidden" id="add_surnetlist" value="" /><span id="add_surnet"></span><span onmouseover="javascript:tooltip.show('${lang_commonselectsurnet}')" onmouseout="javascript:tooltip.hide()" id="add_span"><img src="../img/icon_database.png" alt="${lang_commonselectsurnet}" onclick="javascript:ChooseSurnet(event)" /></span></td>
</tr></tbody></table>
...
<div id="tablewrapper">
	...
	<table id="tableheaders" class="overheaders">
		<thead><tr><th class="nosort"><h3 /></th><th class="nosort"><h3 /></th><th><h3><fmt:message key="common.table.mask" /></h3></th><th><h3><fmt:message key="common.table.name" /></h3></th><th><h3><fmt:message key="admin.subnet" /></h3></th><th><h3><fmt:message key="common.table.ipgw" /></h3></th><th><h3><fmt:message key="admin.vlan" /></h3></th><th><h3><fmt:message key="common.table.ipbc" /></h3></th><th><h3><fmt:message key="norm.surnet" /></h3></th></tr></thead>
	</table>
