...
<fmt:message key="common.click.config" var="lang_commonclickconfig" />
<fmt:message key="common.click.view" var="lang_commonclickview" />
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title><fmt:message key="template.site.title" /></title>
...
<script type="text/javascript" charset="utf-8" src="../js/template_sites.js"></script>
</head>
<body onload='javascript:loadTable()'>
<%@ include file="../menu.jsp" %>
<input type="hidden" id="sqs_id" value="23" />
...
<tbody><tr>
	...
	<td><input type="text" size="3" id="add_mask" value="" /></td>
</tr></tbody></table>
<h3><fmt:message key="template.site.list" /> :</h3>
<div id="tablewrapper">
	<div id="tableheader">
		<div class="search">
	...
	<table id="tableheaders" class="overheaders">
		<thead><tr><th class="nosort"><h3 /></th><th class="nosort"><h3 /></th><th><h3><fmt:message key="common.table.name" /></h3></th><th><h3><fmt:message key="common.table.mask" /></h3></th><th class="nosort"><h3><fmt:message key="admin.vlan" /></h3></th><th class="nosort"><h3><fmt:message key="admin.subnet" /></h3></th><th class="nosort"><h3><fmt:message key="common.table.config" /></h3></th></tr></thead>
	</table>
