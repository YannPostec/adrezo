...
<head>
<title><fmt:message key="template.vlan.title" />${param.tpl}</title>
...
<script type="text/javascript" charset="utf-8" src="../js/template_vlans.js"></script>
</head>
<body onload='javascript:loadTable()'>
<%@ include file="../menu.jsp" %>
<input type="hidden" id="sqs_id" value="24" />
<input type="hidden" id="sqs_limit" value="32" />
<input type="hidden" id="sqs_offset" value="0" />
<input type="hidden" id="sqs_order" value="vid" />
...
<table><thead><tr><th /><th /><th><fmt:message key="common.table.name" /></th><th><fmt:message key="common.table.vid" /></th></tr></thead>
<tbody><tr>
	...
	<td><input type="text" size="30" id="add_name" value="" /></td>
	<td><input type="hidden" id="add_tpl" value="${param.tpl}" /><input type="text" size="5" id="add_vid" value="" /></td>
</tr></tbody></table>
<h3><fmt:message key="template.vlan.list" /> :</h3>
<div id="tablewrapper">
	<div id="tableheader">
		<div class="search">
	...
	<table id="tableheaders" class="overheaders">
		<thead><tr><th class="nosort"><h3 /></th><th class="nosort"><h3 /></th><th><h3><fmt:message key="common.table.name" /></h3></th><th><h3><fmt:message key="common.table.vid" /></h3></th></tr></thead>
	</table>
