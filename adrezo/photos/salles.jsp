...
<input type="hidden" id="sqs_id" value="10" />
<input type="hidden" id="sqs_limit" value="32" />
<input type="hidden" id="sqs_offset" value="0" />
<input type="hidden" id="sqs_order" value="site_name,name" />
...
<table><thead><tr><th /><th /><th><fmt:message key="admin.site" /></th><th><fmt:message key="common.table.name" /></th></tr>
<tobdy><tr>
	...
	<td><input type="text" size="6" id="add_name" value="" /></td>
</tr></tbody></table>
...
<div id="tablewrapper">
	...
	<table id="tableheaders" class="overheaders">
		<thead><tr><th class="nosort"><h3 /></th><th class="nosort"><h3 /></th><th><h3><fmt:message key="admin.site" /></h3></th><th><h3><fmt:message key="common.table.name" /></h3></th></tr></thead>
	</table>
