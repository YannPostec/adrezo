...
TINY.editor = function() {
	var c = [], offset = -30;
	c['bold'] = [4,langdata.edbold, 'a', 'bold'];
	c['italic'] = [5,langdata.editalic, 'a', 'italic'];
	c['underline'] = [6,langdata.edunderline, 'a', 'underline'];
	c['strikethrough'] = [7,langdata.edstrike, 'a', 'strikethrough'];
	c['subscript'] = [8,langdata.edsub, 'a', 'subscript'];
	c['superscript'] = [9,langdata.edsuper, 'a', 'superscript'];
	c['orderedlist'] = [10,langdata.edorder, 'a', 'insertorderedlist'];
	c['unorderedlist'] = [11,langdata.edunorder, 'a', 'insertunorderedlist'];
	c['outdent'] = [12,langdata.edoutdent, 'a', 'outdent'];
	c['indent'] = [13,langdata.edindent, 'a', 'indent'];
	c['leftalign'] = [14,langdata.edlalign, 'a', 'justifyleft'];
	c['centeralign'] = [15,langdata.edcalign, 'a', 'justifycenter'];
	c['rightalign'] = [16,langdata.edralign, 'a', 'justifyright'];
	c['blockjustify'] = [17,langdata.edjustify, 'a', 'justifyfull'];
	c['undo'] = [18,langdata.edundo, 'a', 'undo'];
	c['redo'] = [19,langdata.edredo, 'a', 'redo'];
	c['image'] = [20,langdata.edimg, 'i', 'insertimage', 'Enter Image URL:', 'http://'];
	c['hr'] = [21,langdata.edrule, 'a', 'inserthorizontalrule'];
	c['link'] = [22,langdata.edilink, 'i', 'createlink', 'Enter URL:', 'http://'];
	c['unlink'] = [23,langdata.eddlink, 'a', 'unlink'];
	c['unformat'] = [24,langdata.edformat, 'a', 'removeformat'];
	c['print'] = [25,langdata.edprint, 'a', 'print'];
	function edit(n, obj) {
