	...
	<c:when test="${pageContext.request.method == 'POST' && fn:contains(header.referer,'install.jsp') }">
		...
		<c:catch var="err">
			<sql:transaction>
				...
				<sql:update>create table tpl_subnet (id number not null,tpl number not null,vlan number not null,mask number not null,def varchar2(40) not null,ip varchar2(12) not null,gw varchar2(12))</sql:update>				
		...
		<c:catch var="err">
			<sql:transaction>
				...
				<sql:update>create table tpl_subnet (id integer not null,tpl integer not null,vlan integer not null,mask integer not null,def varchar(40) not null,ip varchar(12) not null,gw varchar(12))</sql:update>				
