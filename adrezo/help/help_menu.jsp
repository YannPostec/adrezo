...
d.add(46,4,'<fmt:message key="admin.site" />','${validUser.lang}/admin_site.html','','','ressource/page.gif','ressource/page.gif',false);
d.add(47,4,'<fmt:message key="admin.mail" />','${validUser.lang}/admin_mail.html','','','ressource/page.gif','ressource/page.gif',false);
d.add(48,4,'<fmt:message key="admin.csv" />','${validUser.lang}/admin_csv.html','','','ressource/page.gif','ressource/page.gif',false);
d.add(49,4,'<fmt:message key="admin.tools" />','${validUser.lang}/admin_tools.html','','','ressource/page.gif','ressource/page.gif',false);
...
d.add(51,5,'<fmt:message key="rezo.subnet" />','${validUser.lang}/rezo_subnet.html','','','ressource/page.gif','ressource/page.gif',false);
d.add(52,5,'<fmt:message key="rezo.vlan" />','${validUser.lang}/rezo_vlan.html','','','ressource/page.gif','ressource/page.gif',false);
d.add(53,5,'<fmt:message key="rezo.red" />','${validUser.lang}/rezo_redundancy.html','','','ressource/page.gif','ressource/page.gif',false);
d.add(54,5,'<fmt:message key="rezo.tools" />','${validUser.lang}/rezo_tools.html','','','ressource/page.gif','ressource/page.gif',false);
</c:if>
