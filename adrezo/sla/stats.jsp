...
<span class="fl" onmouseover="javascript:tooltip.show('${lang_commonclickxls}')" onmouseout="javascript:tooltip.hide()" onclick="javascript:window.open('${pageContext.request.contextPath}/sla/stats_excel.jsp')"><img class="image" src="../img/icon_excel.jpg" alt="${lang_commonclickxls}" /></span>
