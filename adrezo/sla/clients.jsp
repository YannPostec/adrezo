...
<input type="hidden" id="sqs_id" value="16" />
...
<table><thead><tr><th /><th /><th><fmt:message key="common.table.name" /></th><th><fmt:message key="common.table.view" /></th><th><fmt:message key="sla.planning.plan" /></th></tr></thead>
<tbody><tr>
...
<h3><fmt:message key="sla.client.list" /> :</h3>
<div id="tablewrapper">
	<div id="tableheader">
		<div class="search">
	...
	<table id="tableheaders" class="overheaders">
		<thead><tr><th class="nosort"><h3 /></th><th class="nosort"><h3 /></th><th><h3><fmt:message key="common.table.name" /></h3></th><th><h3><fmt:message key="common.table.view" /></h3></th><th><h3><fmt:message key="sla.planning.plan" /></h3></th></tr></thead>
	</table>
