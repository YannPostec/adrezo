...
<script type="text/javascript" charset="utf-8" src="../js/info_subnets.js"></script>
</head>
<body onload='javascript:loadTable()'>
<%@ include file="../menu.jsp" %>
<h2><fmt:message key="info.subnet.list" /> <span class="xls" onmouseover="javascript:tooltip.show('${lang_commonclickxls}')" onmouseout="javascript:tooltip.hide()" onclick="javascript:window.open('${pageContext.request.contextPath}/excelinfos?type=subnet')"><img class="image" src="../img/icon_excel.jpg" alt="${lang_commonclickxls}" /></span></h2>
<input type="hidden" id="sqs_id" value="1" />
