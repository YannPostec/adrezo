...
<head>
<title><fmt:message key="info.fill.title" /></title>
...
<h2><fmt:message key="info.fill.list" /> <span class="xls" onmouseover="javascript:tooltip.show('${lang_commonclickxls}')" onmouseout="javascript:tooltip.hide()" onclick="javascript:window.open('${pageContext.request.contextPath}/excelinfos?type=fill')"><img class="image" src="../img/icon_excel.jpg" alt="${lang_commonclickxls}" /></span></h2>
